<froala>
    <textarea name="{opts.name}" class="form-control" placeholder="Enter body here"></textarea>
    <script>
//            var ms = [
//                {
//                    name: 'Image',
...
//            });
            this.on('mount', () => {
                $('textarea', this.root).froalaEditor({
                    toolbarButtons: ['paragraphFormat', 'bold', 'underline', 'formatUL', 'color', 'align', 'quote', 'insertLink', 'insertImage', 'insertFile', 'insertTable', 'undo', 'redo', 'html', 'fullscreen'],
                    heightMin: 300,
                    imageDefaultWidth: 0,
